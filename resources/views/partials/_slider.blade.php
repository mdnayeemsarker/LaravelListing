     ...
     <div class="container">
         <div class="row align-items-center mb-5">
             ...
             <div class="col-lg-6 text-lg-end">
                 <p><a href="{{ 'properties' }}" class="btn btn-primary py-3 px-4 text-white">View all properties</a>
                 </p>
             </div>
         </div>
         <div class="row">
                     ...
                     <div class="property-slider">
                         <div class="property-item">
                             ...
                             <div class="property-content">
                                 ...
                                 <div>
                                     <span class="d-block text-black-50 mb-2">5232 California Fake, Ave. 21BC</span>
